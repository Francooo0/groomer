...
import { WobbleCard } from "./Wobble-Card"; // Adjust this import if the path is incorrect
...
export function OurServices() {
    return (
        <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full bg-gradient-to-t from-cream to-transparent pt-2"
        >
